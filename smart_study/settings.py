"""
Django settings for Smart Study project.
"""
...
# Security settings
SECRET_KEY = config('SECRET_KEY', default='django-insecure-smart-study-secret-key-change-in-production')
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='Smart Study <noreply@smartstudy.com>')
